...
/*void command_open(std::string loguid, std::string logpass, std::string name, std::string fname,
                 std::string start_value,std::string timeactive)
{
    ...
    int i=receive_msgTCP(client,rest);
    if(i){
...
void command_bid(std::string loguid, std::string logpass, std::string auction,
                 std::string value)
{
    std::string message;
    std::string rest;
