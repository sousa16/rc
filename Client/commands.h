...
void command_open(std::string AUCIP,std::string AUCport,std::string loguid, std::string logpass, std::string name, std::string fname,std::string start_value,std::string timeactive);
...
void command_bid(std::string AUCIP,std::string AUCport,std::string loguid, std::string logpass, std::string auction,std::string value);
void command_sr(std::string auction,int &client,struct addrinfo* &resClient,struct sockaddr_in &addr);

#endif //commands.h o user